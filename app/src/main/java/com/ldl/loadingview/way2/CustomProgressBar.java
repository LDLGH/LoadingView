...
public class CustomProgressBar extends View {
    ...
    public void updateUI(double pos) {
        mProgress = (int) (pos * 3.6);
        mTitleText = (int) pos + "%";
        Log.d("updateUI", mProgress + "");
        Log.d("updateUI", mTitleText);
        invalidate();
//        new Thread() {
//            public void run() {
//                postInvalidate();
...
//        }.start();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制字体
        canvas.drawText(mTitleText, getWidth() / 2 - mBound.width() / 2 - mCircleWidth / 2, getHeight() / 2 + mBound.height() / 2 + mCircleWidth / 2, mPaint);
